...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-ep", &rewards, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-p1", &init_conf.p1, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-p2", &init_conf.p2, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-p3", &init_conf.p3, NULL));

    PetscCall(VecCreateSeq(PETSC_COMM_SELF, 3, &U));
    PetscCall(VecSetValue(U, 0, init_cond.x, INSERT_VALUES));
    PetscCall(VecSetValue(U, 1, init_cond.y, INSERT_VALUES));
    PetscCall(VecSetValue(U, 2, init_cond.z, INSERT_VALUES));
