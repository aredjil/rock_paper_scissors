...
int main(int argc, char *argv[])
{
    ...
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-x", &parms.ep, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-y", &parms.ep, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-z", &parms.ep, NULL));
