...
def main():
    ...
    fig, ax = plt.subplots(ncols=1, nrows=3, figsize=(12, 6))
    ax[0].plot(t, p1, label="$R(t)$", linestyle="--")
    ax[1].plot(t, p2, label="$P(t)$", linestyle="--")
    ax[2].plot(t, p3, label="$S(t)$", linestyle="--")
