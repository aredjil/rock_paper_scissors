...
int main(int argc, char *argv[])
{
    ...
    // p1 + p2 + p3 = 1
    init_cond.p1 = 1.0/4; // Intial abundance of Rock players 
    init_cond.p2 = 1.0/4;//  Intial abundance of Paper players
    init_cond.p3 = 1.0/3;//  Intial abundance of Scissor players
    // The sum of the players must add up to one 
    payoffs rewards;
