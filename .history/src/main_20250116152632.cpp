...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a01", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a02", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a10", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a11", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a12", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a20", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a21", &rewards.a, NULL));
    PetscCall(PetscOptionsGetReal(NULL, NULL, "-a22", &rewards.a, NULL));
