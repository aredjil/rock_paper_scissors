...
def main():
    ...
    ax.plot(t, p1, linewidth=2, label="$R(t)$")
    ax.plot(t, p2, linewidth=2, label="$P(t)$")
    ax.plot(t, p3, linewidth=2, label="$S(t)$")
    ax.set_xlim(0,)
    ax.set_xlabel("t")
